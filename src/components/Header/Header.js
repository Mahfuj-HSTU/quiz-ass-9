...
const Header = () => {
    ...
    return (
        <nav className="w-full bg-slate-100 shadow-lg shadow-slate-300 mb-12">
            <div className="justify-between px-4 mx-auto lg:max-w-7xl md:items-center md:flex md:px-8">
                <div>
                    <div className="flex items-center justify-between py-3 md:py-5 md:block">
                        <Link to='/'><h2 className='sm:text-3xl md:text-4xl text-3xl text-indigo-700 font-semibold '>My Quiz</h2></Link>
